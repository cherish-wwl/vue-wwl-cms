...
var env = process.env.NODE_ENV === 'example' ? require('../config/example.env') : require('../config/prod.env');
var webpackConfig = merge(baseWebpackConfig, {
  ...
  new HtmlWebpackPlugin({
    filename: process.env.NODE_ENV === 'example' ? path.resolve(__dirname, '../doc/index.html') : config.build.index,
    template: 'index.html',
    inject: true,
    minify: {
      removeComments: true,
